...
public class WorldGenUnderwaterBlock extends WorldGenerator
{
    ...
    public WorldGenUnderwaterBlock(int par1, int par2)
    {
        minableBlockId = par1;
        numberOfBlocks = par2;
    }
            ...
            for (int l1 = j; l1 <= i1; l1++)
            {
                ...
                for (int i2 = k; i2 <= j1; i2++)
                {
                    ...
                    for (int j2 = l; j2 <= k1; j2++)
                    {
                        ...
                        //TODO: Work out how to autodetect water-based fluids.
